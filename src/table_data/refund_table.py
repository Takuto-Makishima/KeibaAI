...
class RefundTable:
    """ 払い戻しテーブルクラス """
    def __init__(self, refund, is_today=False):
        """ コンストラクタ 
            Args:
        ...
        self.__refund_table = refund
        self.__place = self.cnv_table(refund, "複勝")
        self.__win = self.cnv_table(refund, "単勝")
        self.__wide = self.cnv_table(refund, "ワイド")
        self.__bracket_quinella = self.cnv_table(refund, "枠連")
        self.__quinella = self.cnv_table(refund, "馬連")
        self.__exacta = self.cnv_table(refund, "馬単")
        self.__trio = self.cnv_table(refund, "3連複")
        self.__tierce = self.cnv_table(refund, "3連単")
        a=1
    ...
    def bracket_quinella(self):
        return self.__bracket_quinella
    @property
    def quinella(self):
        return self.__quinella
    @property
    def exacta(self):
        return self.__exacta
    @property
    def trio(self):
        return self.__trio
    @property
    def tierce(self):
        return self.__tierce
